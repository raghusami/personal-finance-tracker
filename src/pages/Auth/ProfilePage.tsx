  ...
  return (
    <div className="flex flex-col gap-2 p-4">
      ...
      <div className="flex justify-left">
        <div className="card bg-white border border-gray-200 shadow-sm w-full max-w-3xl">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="grid gap-5">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    />
                    {errors.mobileNumber && (
                      <p className="text-error text-xs">{errors.mobileNumber.message}</p>
                    )}
                  </div>
                </div>
                ...
                {/* Currency */}
                <div>
                  <label className="label font-semibold">Preferred Currency</label>
                  <select {...register("preferredCurrency")} className="select select-bordered w-full">
